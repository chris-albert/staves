...
interface MidiTrackHeaderProps {
  track: Track;
      ...
      <div className="flex flex-1 flex-col gap-1.5 px-3 py-2">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <svg width="14" height="14" viewBox="0 0 14 14" fill="none" className="flex-shrink-0 text-zinc-500">
            <rect x="1" y="8" width="2" height="5" rx="0.5" stroke="currentColor" strokeWidth="1" fill="currentColor" fillOpacity="0.15" />
            <rect x="4" y="6" width="2" height="7" rx="0.5" stroke="currentColor" strokeWidth="1" fill="currentColor" fillOpacity="0.15" />
            <rect x="7" y="4" width="2" height="9" rx="0.5" stroke="currentColor" strokeWidth="1" fill="currentColor" fillOpacity="0.15" />
            <rect x="10" y="2" width="2" height="11" rx="0.5" stroke="currentColor" strokeWidth="1" fill="currentColor" fillOpacity="0.15" />
